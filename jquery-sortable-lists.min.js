...
e.opener.openerClass).css("background-image","url("+e.opener.close+")").css(e.opener.openerCss).on("mousedown",function(a){a=d(this).closest("li");a.hasClass("sortableListsClosed")?r(a):z(a);return!1}),b={isRelEFP:null,oEl:null,rootEl:null,cEl:null,upScroll:!1,downScroll:!1,pX:0,pY:0,cX:0,cY:0,isAllowed:!0,e:{pageX:0,pageY:0,clientX:0,clientY:0},doc:d(document),win:d(window)};e.opener.active&&d(this).find("li").each(function(){var a=d(this);a.children("ul,ol").length&&(w.clone(!0).prependTo(a.children("div").first()),
a.hasClass("sortableListsOpen")||(a.addClass("sortableListsClosed"),z(a)))});return this.on("mousedown",function(a){var f=d(a.target);if(!f.hasClass(e.ignoreClass)){a.preventDefault();var f=f.is("li")?f:f.closest("li"),c=d(this);if(f[0]){e.onDragStart(a,f);b.isDragged=!0;var g=parseInt(f.css("margin-top")),k=parseInt(f.css("margin-bottom")),h=parseInt(f.css("margin-left")),n=parseInt(f.css("margin-right")),q=f.offset(),r=f.innerHeight();b.rootEl={el:c,offset:c.offset(),rootElClass:c.attr("class")};
b.cEl={el:f,mT:g,mL:h,mB:k,mR:n,offset:q};b.cEl.xyOffsetDiff={X:a.pageX-b.cEl.offset.left,Y:a.pageY-b.cEl.offset.top};b.cEl.el.addClass("sortableListsCurrent "+e.currElClass);f.before(H);a=b.placeholderNode=d("#sortableListsPlaceholder");f.css({width:f.width(),position:"absolute",top:q.top-g,left:q.left-h}).prependTo(G);a.css({display:"block",height:r});l.css("height",r);b.doc.on("mousemove",p).on("mouseup",m)}}})};d.fn.sortableListsToArray=function(g,p){g=g||[];var m=0;this.children("li").each(function(){var h=
d(this),n={},q=h.attr("id");if(!q)throw console.log(h),"Previous item in console.log has no id. It is necessary to create the array.";n.id=q;n.parentId=p;n.value=h.data("value");n.order=m;g.push(n);h.children("ul,ol").sortableListsToArray(g,q);m++});return g};d.fn.sortableListsToHierarchy=function(){var g=[],p=0;d(this).children("li").each(function(){var m=d(this),h={},n=m.attr("id");if(!n)throw console.log(m),"Previous item in console.log has no id. It is necessary to create the array.";h.id=n;h.value=
m.data("value");h.order=p;g.push(h);h.children=m.children("ul,ol").sortableListsToHierarchy();p++});return g};d.fn.sortableListsToString=function(g,p){g=g||[];p=p||"";d(this).children("li").each(function(){var m=d(this),h=m.attr("id");if(!h)throw console.log(m),"Previous item in console.log has no id. It is necessary to create the array.";g.push(encodeURIComponent(h)+"="+encodeURIComponent(p));d(this).children("ul,ol").sortableListsToString(g,h)});return g.join("&")}})(jQuery);
